...
\imagefigure{string-mutation.png}{Mutation of a string genotype \cite{string-mutation}}
...
\imagefigurefull{tree-mutation.png}{Mutation of a tree-like genotype \cite{tree-mutation}}{1}
